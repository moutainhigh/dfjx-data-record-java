...
--
-- Host: localhost    Database: data_record
-- ------------------------------------------------------
...
--
-- Table structure for table `rcd_report_data_job16`
--

DROP TABLE IF EXISTS `rcd_report_data_job16`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job16` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
  `fld_id` int(11) DEFAULT NULL,
  `record_data` varchar(500) DEFAULT NULL,
  `data_status` int(11) DEFAULT NULL COMMENT '0:填报中\n1:已提交\n2:未提交',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32700 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `rcd_report_data_job17`
--

DROP TABLE IF EXISTS `rcd_report_data_job17`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job17` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
  `fld_id` int(11) DEFAULT NULL,
  `record_data` varchar(400) DEFAULT NULL,
  `data_status` int(11) DEFAULT '0' COMMENT '0:填报中\n1:已提交\n2:未提交',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `rcd_report_data_job18`
--

DROP TABLE IF EXISTS `rcd_report_data_job18`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job18` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job19`
--

DROP TABLE IF EXISTS `rcd_report_data_job19`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job19` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job20`
--

DROP TABLE IF EXISTS `rcd_report_data_job20`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job20` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
  ...
  `data_status` int(11) DEFAULT '0' COMMENT '0:填报中\n1:已提交\n2:未提交',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=57674 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `rcd_report_data_job27`
--

DROP TABLE IF EXISTS `rcd_report_data_job27`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job27` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job28`
--

DROP TABLE IF EXISTS `rcd_report_data_job28`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job28` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job29`
--

DROP TABLE IF EXISTS `rcd_report_data_job29`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job29` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job30`
--

DROP TABLE IF EXISTS `rcd_report_data_job30`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job30` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job31`
--

DROP TABLE IF EXISTS `rcd_report_data_job31`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job31` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job32`
--

DROP TABLE IF EXISTS `rcd_report_data_job32`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job32` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job33`
--

DROP TABLE IF EXISTS `rcd_report_data_job33`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job33` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job34`
--

DROP TABLE IF EXISTS `rcd_report_data_job34`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job34` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job35`
--

DROP TABLE IF EXISTS `rcd_report_data_job35`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job35` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job36`
--

DROP TABLE IF EXISTS `rcd_report_data_job36`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job36` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job37`
--

DROP TABLE IF EXISTS `rcd_report_data_job37`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job37` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job38`
--

DROP TABLE IF EXISTS `rcd_report_data_job38`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job38` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job41`
--

DROP TABLE IF EXISTS `rcd_report_data_job41`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job41` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job42`
--

DROP TABLE IF EXISTS `rcd_report_data_job42`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job42` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job44`
--

DROP TABLE IF EXISTS `rcd_report_data_job44`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job44` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job45`
--

DROP TABLE IF EXISTS `rcd_report_data_job45`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job45` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job47`
--

DROP TABLE IF EXISTS `rcd_report_data_job47`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job47` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `rcd_report_data_job48`
--

DROP TABLE IF EXISTS `rcd_report_data_job48`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rcd_report_data_job48` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `report_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `colum_id` int(11) DEFAULT NULL,
...
-- Dump completed on 2020-07-31 14:40:05
